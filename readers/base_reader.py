...
# This file includes modifications to “dataset_reader.py” 
...
"""
Adaptation of allennlp Dataset Reader Class to allow taking predictor
as an input to allow on fly annotations
"""
...
class DatasetReader(Registrable):
    ...
    def read(self, file_path: str, **kwargs) -> Iterable[Instance]:
        """
        ...
        if lazy:
            return _LazyInstances(lambda: iter(self._read(file_path, **kwargs)))
        else:
            instances = self._read(file_path, **kwargs)
